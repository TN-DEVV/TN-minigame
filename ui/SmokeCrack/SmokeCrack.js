...
function getInputValues() {
    ...
    var macIpCombs = {
        '7c:89:3e:c8:cc:65-192.168.0.105': [10, 14, 10], //Easy (seconds, maxChars)
        'fb:d4:31:c:38:e8-192.168.0.205': [8, 18, 14], //Medium 
        '71:21:e3:ea:f6:d0-192.168.0.179': [6, 20, 16], //Hard
    };
...
function stopGame(gameWin, keyPressListener) {
    ...
    const resultdata = {
        success: gameWin,
        diff: totalSeconds === 10 ? "easy" : totalSeconds === 8 ? "medium" : "hard",
    };
    setTimeout(function () {
        endContainer.style.display = 'none';
        window.location.href = "../index.html";
        fetch('https://TN-minigame/smokeresult', {
            method: 'POST',
            headers: {
...
document.addEventListener("keydown", function(event) {
    if (event.key === "Escape") {
        window.location.href = "../index.html";
        fetch('https://TN-minigame/closesmoke', { method: 'POST' });
    }
});